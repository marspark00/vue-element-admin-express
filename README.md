...
# 前端
  ...
  cheap-source-map
  调试的时候用  source-map   虽然每次都可以看见，但是生成文件较多，速度慢
  
  开发的时候用eval     速度快，但是调试不方便,无法还原源码
  ...
  ### 路由权限校验
  ![路由权限校验.png](https://s2.ax1x.com/2020/02/15/1zUjZ4.png)

  ### 动态路由分析
  ![动态路由分析.png](https://s2.ax1x.com/2020/02/15/1zwWqO.png)
...
| </br>IE / Edge | </br>Firefox | </br>Chrome | [<img src="https://raw.githubusercontent.com/alrra/browser-logos/master/src/safari/safari_48x48.png" alt="Safari" width="24px" height="24px" />](https://godban.github.io/browsers-support-badges/)</br>Safari |
| --------- | --------- | --------- | --------- |
